  ...
  <div class="modal-content">
    ...
    <div class="popup">
                <div class = "popup-content" >
                    ...
                    <div class="input_id">
                    <input type="number" id="tokenID" name="fname"><br><br>
                    </div>
...
async function onConnect() {
    ...
    try {
        ...
        checkApproved = await nft.methods.isApprovedForAll(account, ADDRESS).call();
...
async function onApprove(){
    ...
    if(checkApproved) return toastr.info(`You have already Approved. You can proceed to stake your NFT`,'INFO');
...
async function onStakeAll() {
    ...
    nfts = await contract.methods.tokensOf(account).call()
    console.log(nfts)
    if(nfts.length == 0){ 
